...
public class PermissionInterceptor implements AsyncHandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(handler instanceof HandlerMethod){
            ...
            // 如果方法和类上上没有注解，则直接放行
            if(permission == null || permission.role()== UserRole.VISITOR){
...
//                }
            ...
            if (ReqInfoContext.getReqInfo() == null || ReqInfoContext.getReqInfo().getUserId() == null) {
                ...
                if (handlerMethod.getMethod().getAnnotation(ResponseBody.class) != null
                    ...
                    response.getWriter().println(JsonUtil.objToStr(CommonResult.error(StatusEnum.FORBID_NOTLOGIN.getMsg())));
            ...
            if (permission.role() == UserRole.ADMIN && !(UserRole.ADMIN.getCode() ==userRole.intValue())) {
                // 设置为无权限
