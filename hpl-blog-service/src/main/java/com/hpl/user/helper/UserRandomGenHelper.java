...
public class UserRandomGenHelper {
    public final String[] NAME_DECORATE = new String[]{
    ...
    public final String[] NAME_BODY = new String[]{
    ...
    private final int AVATAR_NUM = 92;

    private final String AVATAR_TEMPLATE = "https://cdn.tobebetterjavaer.com/paicoding/avatar/%04d.png";
