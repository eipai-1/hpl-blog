 ...
 */
@Service
public class oldCategoryServiceImpl extends ServiceImpl<OldCategoryMapper, oldCategory> implements oldCategoryService {
...
//                oldCategory category = categoryMapper.selectOne(wrapper);
...
//    }
    ...
    public List<CategoryDTO> getAllCategories() {
        ...
        wrapper.eq(oldCategory::getDeleted, CommonDeletedEnum.NO.getCode())
                .eq(oldCategory::getStatus, PublishStatusEnum.PUBLISHED.getCode())
    ...
    private CategoryDTO categoryToDTO(oldCategory oldCategory) {
        CategoryDTO dto = new CategoryDTO();
        dto.setCategoryName(oldCategory.getCategoryName());
        dto.setCategoryId(oldCategory.getId());
        dto.setRank(oldCategory.getRank());
        dto.setStatus(oldCategory.getStatus());
        return dto;
    }
